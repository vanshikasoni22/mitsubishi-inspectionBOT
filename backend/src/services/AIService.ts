...
const DAMAGE_LIBRARY: Record<string, {
  ...
  DENT: {
    ...
    talkingPoints: ['Transportation carrier liable for damage. File carrier insurance claim with this photographic evidence.', 'OEM carries 15% liability based on packaging specification breach.', 'Part rejected per OEM specification. Request full credit or replacement unit within 30 days.', 'Downtime impact included in total loss — use as negotiation leverage.'],
    negotiationSummary: 'Based on AI analysis, estimated total cost impact is calculated. 75% liability attributed to logistics. Recommended negotiation opening.',
  ...
  RUST: {
    ...
    talkingPoints: ['Customer bears 80% liability — evidence of improper storage or handling.', 'File a non-conformance report with the customer site quality team.', 'Part rejected per OEM corrosion standard. Full credit or replacement required.', 'Environmental hazard risk included in loss calculation.'],
    negotiationSummary: 'Based on AI analysis, estimated total cost impact is calculated. 80% liability attributed to customer mishandling. Recommended negotiation opening.',
  ...
  CORROSION: {
    ...
    talkingPoints: ['Customer liability: 65% — improper storage conditions identified.', 'Transport carrier shares 20% liability for inadequate moisture protection packaging.', 'Part rejected — corrosion depth exceeds OEM tolerance by 2x.'],
    negotiationSummary: 'Based on AI analysis, estimated total cost impact is calculated. 65% attributed to customer. Recommended negotiation opening.',
  ...
  SCRATCH: {
    ...
    talkingPoints: ['Scratch defect confirmed at high confidence — part rejected per OEM QA rules.', 'Transport carrier shares 40% liability.', 'Part rejected. Initiate return-to-supplier process.'],
    negotiationSummary: 'Based on AI analysis, scratch defect requires part rejection. Recommended negotiation opening.',
  ...
  IMPACT_MARK: {
    ...
    talkingPoints: ['Transport carrier 70% liable — impact consistent with drop event during logistics.', 'Sub-surface ultrasonic inspection required before final verdict.', 'Escalate to senior inspector for physical measurement.'],
    negotiationSummary: 'Based on AI analysis, estimated total cost impact is calculated. Manual review required. Recommended negotiation opening.',
  ...
  PAINT_PEEL: {
    ...
    talkingPoints: ['OEM carries 60% liability — paint adhesion failure is a manufacturing defect.', 'Request formal non-conformance report from OEM quality department.', 'Manual review mandatory before resale — corrosion risk unconfirmed.'],
    negotiationSummary: 'Based on AI analysis, estimated total cost impact is calculated. 60% OEM liability. Recommended negotiation opening.',
  ...
  PAINT_THICKNESS_ISSUE: {
    ...
    talkingPoints: ['OEM carries 85% liability — manufacturing defect confirmed by measurement data.', 'Request full batch recall check for same production lot.'],
    negotiationSummary: 'Based on AI analysis, estimated total cost impact is calculated. 85% OEM liability. Recommended negotiation opening.',
